...
class _HomePageState extends State<HomePage> {
  // A boolean variable to track the current theme mode
  // bool isDarkMode = false;
  //
  // // A method to toggle the theme mode and update the state
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          MyButton(lable: "+ Add Task", onTap: () => print('My Buttom actopm ...'))
          // ElevatedButton(
          //     onPressed: () async {
  ...
  _appBar() {
    return AppBar(
      ...
      // leading:  Container(
      //   child: IconButton(
      //     icon: Icon(isDarkMode ? Icons.wb_sunny_outlined:Icons.nightlight_rounded),
      //     onPressed: ()=>{
      //       toggleThemeMode(),
